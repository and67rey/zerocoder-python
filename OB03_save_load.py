...
class Zoo:
    ...
    def load_from_file(filename: str):
        ...
        try:
            ...
            return Zoo(name="Новый зоопарк")


# Пример использования

# Имя файла для сохранения данных
zoo_file = "zoo_state.pkl"

if os.path.isfile(zoo_file):
    print(f"Файл '{zoo_file}' существует в текущей директории.")
    # Загрузка сохраненного состояния зоопарка
    zoo = Zoo.load_from_file(zoo_file)
    # Вывод информации о зоопарке
    zoo.show_animals()
    zoo.show_employees()
else:
    print(f"Файл '{zoo_file}' не найден.")
    # Создание зоопарка
